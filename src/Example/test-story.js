    ...
    "done",
    {
            ...
            opts: [
              ...
              { "*": ".^.c-3", flg: 20 },
              {
                "c-1": [
                  ...
                  "nop",
                  "^ they'll come back and demand I talk.",
                  "\n",
                  { "->": ".^.^" },
                  { "->": ".^.^.^.g-1" },
                  { "#f": 5 },
            ...
            [
              [
                ...
                [
                  ...
                  "/ev",
                  { "*": ".^.^.c-0", flg: 18 },
                  { s: ['^"Commander."', { "->": "$r", var: true }, null] },
                ],
                [
                  "ev",
                  { "^->": "start.waited.0.g-0.5.$r1" },
                  { "temp=": "$r" },
                  "str",
                  { "->": ".^.s" },
                  [{ "#n": "$r1" }],
                  "/str",
                  { "CNT?": "start.0.opts.c-2.12.c-2" },
                  "!",
                  "/ev",
                  { "*": ".^.^.c-1", flg: 19 },
                  {
                ...
                "g-2": [
                  ...
                  { "*": ".^.c-10", flg: 21 },
                  {
                    "c-7": [
                      ...
                      [
                        { "->": ".^.b", c: true },
                        { b: ["^lift the mug", { "->": ".^.^.^.8" }, null] },
                      ],
                      [
                        { "->": ".^.b" },
                        { b: ["^take the mug,", { "->": ".^.^.^.8" }, null] },
                      ],
                      "nop",
      ...
      here_at_bletchley_diversion: [
        [
          ...
          [
            { "->": ".^.b", c: true },
            { b: ["^You're a sensitive soul.", { "->": ".^.^.^.21" }, null] },
          ],
          "nop",
          '^"',
          "\n",
          [
            "ev",
            { "^->": "here_at_bletchley_diversion.0.24.$r1" },
            { "temp=": "$r" },
            "str",
            { "->": ".^.s" },
            [{ "#n": "$r1" }],
            ...
            "/ev",
            { "*": ".^.^.c-0", flg: 22 },
            { s: ["^\"I'm fine", { "->": "$r", var: true }, null] },
          ],
          [
            "ev",
            { "^->": "here_at_bletchley_diversion.0.25.$r1" },
            { "temp=": "$r" },
            "str",
            { "->": ".^.s" },
            [{ "#n": "$r1" }],
          ...
          [
            "ev",
            { "^->": "here_at_bletchley_diversion.0.26.$r1" },
            { "temp=": "$r" },
            "str",
            { "->": ".^.s" },
            [{ "#n": "$r1" }],
          ...
          { "*": ".^.c-4", flg: 20 },
          {
            "c-0": [
              "ev",
              { "^->": "here_at_bletchley_diversion.0.c-0.$r2" },
              "/ev",
              { "temp=": "$r" },
              { "->": ".^.^.24.s" },
              [{ "#n": "$r2" }],
            ...
            "c-1": [
              "ev",
              { "^->": "here_at_bletchley_diversion.0.c-1.$r2" },
              "/ev",
              { "temp=": "$r" },
              { "->": ".^.^.25.s" },
              [{ "#n": "$r2" }],
            ...
            "c-2": [
              "ev",
              { "^->": "here_at_bletchley_diversion.0.c-2.$r2" },
              "/ev",
              { "temp=": "$r" },
              { "->": ".^.^.26.s" },
              [{ "#n": "$r2" }],
              ...
              [
                [
                  "ev",
                  { "^->": "here_at_bletchley_diversion.0.c-2.33.0.$r1" },
                  { "temp=": "$r" },
                  "str",
                  { "->": ".^.s" },
                  [{ "#n": "$r1" }],
                  ...
                  "/ev",
                  { "*": ".^.^.c-0", flg: 22 },
                  { s: ['^"Of my genius.', { "->": "$r", var: true }, null] },
                ],
                [
                  "ev",
                  { "^->": "here_at_bletchley_diversion.0.c-2.33.1.$r1" },
                  { "temp=": "$r" },
                  "str",
                  { "->": ".^.s" },
                  [{ "#n": "$r1" }],
                  ...
                  "/ev",
                  { "*": ".^.^.c-1", flg: 22 },
                  { s: ['^"Of my standing.', { "->": "$r", var: true }, null] },
                ],
                "ev",
                "str",
                "^Evade",
                ...
                { "*": ".^.c-2", flg: 20 },
                {
                  "c-0": [
                    "ev",
                    { "^->": "here_at_bletchley_diversion.0.c-2.33.c-0.$r2" },
                    "/ev",
                    { "temp=": "$r" },
                    { "->": ".^.^.0.s" },
                    [{ "#n": "$r2" }],
                      ...
                      { "*": ".^.c-2", flg: 20 },
                      {
                        ...
                        suggest_its_a_lie: [
                          ...
                          [
                            ...
                            {
                              "^->":
                                "here_at_bletchley_diversion.0.c-2.33.c-0.10.suggest_its_a_lie.4.$r1",
                            },
                            { "temp=": "$r" },
                            "str",
                            { "->": ".^.s" },
                          ...
                          [
                            ...
                            {
                              "^->":
                                "here_at_bletchley_diversion.0.c-2.33.c-0.10.suggest_its_a_lie.5.$r1",
                            },
                            { "temp=": "$r" },
                            "str",
                            { "->": ".^.s" },
                          ...
                          { "*": ".^.c-5", flg: 20 },
                          {
                            "c-3": [
                              ...
                              {
                                "^->":
                                  "here_at_bletchley_diversion.0.c-2.33.c-0.10.suggest_its_a_lie.c-3.$r2",
                              },
                              "/ev",
                              { "temp=": "$r" },
                              { "->": ".^.^.4.s" },
                            ...
                            "c-4": [
                              ...
                              {
                                "^->":
                                  "here_at_bletchley_diversion.0.c-2.33.c-0.10.suggest_its_a_lie.c-4.$r2",
                              },
                              "/ev",
                              { "temp=": "$r" },
                              { "->": ".^.^.5.s" },
                  ...
                  "c-1": [
                    "ev",
                    { "^->": "here_at_bletchley_diversion.0.c-2.33.c-1.$r2" },
                    "/ev",
                    { "temp=": "$r" },
                    { "->": ".^.^.1.s" },
                    [{ "#n": "$r2" }],
            ...
            done: [{ "->": "harris_demands_component" }, null],
          },
        ],
        { "#f": 1 },
      ],
      harris_demands_component: [
        [
          '^"',
          "ev",
          { "CNT?": "here_at_bletchley_diversion" },
          "/ev",
          [
            { "->": ".^.b", c: true },
            { b: ["^Please", { "->": ".^.^.^.6" }, null] },
          ...
          [
            { "->": ".^.b", c: true },
            { b: ["^sweating slightly", { "->": ".^.^.^.15" }, null] },
          ],
          [
            { "->": ".^.b" },
            { b: ["^wasting no time", { "->": ".^.^.^.15" }, null] },
          ],
          "nop",
          ...
          { "*": ".^.c-3", flg: 20 },
          {
            ...
            "g-0": [
              ...
              { "*": ".^.c-7", flg: 20 },
              {
                ...
                "c-7": [
                  ...
                  [
                    { "->": ".^.b", c: true },
                    { b: ["^I demand a lawyer.", { "->": ".^.^.^.10" }, null] },
                  ],
                  [
                    { "->": ".^.b" },
                    { b: ["^I want a lawyer.", { "->": ".^.^.^.10" }, null] },
                  ],
                  "nop",
                  '^"',
                  "\n",
            ...
            "g-1": [
              '^"Lapsang Souchong," he ',
              "ev",
              { "CNT?": ".^.^.silence.drinkit.c-10.2.drinkfromcup" },
              "/ev",
              [
                { "->": ".^.b", c: true },
                { b: ["^remarks", { "->": ".^.^.^.6" }, null] },
      ...
      admitted_to_something: [
        ...
        ],
        {
          ...
          ive_done_things: [
            ...
            "ev",
            { "CNT?": "harris_demands_component.0.g-1.c-14" },
            "/ev",
            [
              { "->": ".^.b", c: true },
              { b: ["^ helplessly", { "->": ".^.^.^.5" }, null] },
          ...
          { "*": ".^.c-0", flg: 20 },
          {
                ...
                "c-4": [
                  ...
                  [
                    ...
                    { "*": ".^.c-1", flg: 20 },
                    {
                      ...
                      "c-1": [
                        '^ "Perhaps. But I didn\'t choose this life." ',
                        "\n",
            ...
            "g-2": [
              ...
              [
                ...
                { "VAR?": "drugged" },
                "/ev",
                { "temp=": "harris_thinks_youre_drugged" },
                "ev",
                { "VAR?": "drugged" },
                "/ev",
                [
                ...
                { "*": ".^.c-11", flg: 20 },
                {
                  ...
                  "c-9": [
                    ...
                    [
                      { "->": ".^.b", c: true },
                      {
                        b: [
                          ...
                          "ev",
                          { "VAR?": "harris_thinks_youre_drugged" },
                          "/ev",
                          [
                            { "->": ".^.b", c: true },
                            {
                    ...
                    true,
                    "/ev",
                    { "VAR=": "revealedhooperasculprit", re: true },
                          ...
                          [
                            ...
                            { "*": ".^.c-3", flg: 20 },
                            {
                              ...
                              "c-1": [
                                ...
                                {
                                  "->": "i_met_a_young_man.passed_onto_hooper",
                                },
                                "\n",
                                { "#f": 5 },
                              ],
                              ...
                              "c-3": [
                                "^ ",
                                { "->": "i_met_a_young_man.i_dont_have_it" },
                                "\n",
                                { "#f": 5 },
                              ],
                            },
                  ...
                  [
                    ...
                    { "*": ".^.c-1", flg: 20 },
                    {
                      ...
                      "c-1": [
                        "^ ",
                        {
                          "->": "claim_hooper_took_component.its_your_problem",
                        },
                        "\n",
                        { "#f": 5 },
                      ],
            ...
            "g-1": [
              ...
              [
                ...
                [
                  ...
                  {
                    "^->":
                      "claim_hooper_took_component.0.g-1.hoopers_hut_3.2.$r1",
                  },
                  { "temp=": "$r" },
                  "str",
                  { "->": ".^.s" },
                ...
                [
                  ...
                  {
                    "^->":
                      "claim_hooper_took_component.0.g-1.hoopers_hut_3.3.$r1",
                  },
                  { "temp=": "$r" },
                  "str",
                  { "->": ".^.s" },
                ...
                ],
                {
                  "c-5": [
                    ...
                    {
                      "^->":
                        "claim_hooper_took_component.0.g-1.hoopers_hut_3.c-5.$r2",
                    },
                    "/ev",
                    { "temp=": "$r" },
                    { "->": ".^.^.2.s" },
                  ...
                  "c-6": [
                    ...
                    {
                      "^->":
                        "claim_hooper_took_component.0.g-1.hoopers_hut_3.c-6.$r2",
                    },
                    "/ev",
                    { "temp=": "$r" },
                    { "->": ".^.^.3.s" },
                    [{ "#n": "$r2" }],
                    '^ You knew all along. Why did you threaten me?"',
                    "\n",
                ...
                "c-7": [
                  ...
                  [
                    [
                      ...
                      {
                        "^->":
                          "claim_hooper_took_component.0.we_wont_guess.c-7.6.0.$r1",
                      },
                      { "temp=": "$r" },
                      "str",
                      { "->": ".^.s" },
                    ...
                    [
                      ...
                      {
                        "^->":
                          "claim_hooper_took_component.0.we_wont_guess.c-7.6.1.$r1",
                      },
                      { "temp=": "$r" },
                      "str",
                      { "->": ".^.s" },
                    ...
                    ],
                    {
                      "c-0": [
                        ...
                        {
                          "^->":
                            "claim_hooper_took_component.0.we_wont_guess.c-7.6.c-0.$r2",
                        },
                        "/ev",
                        { "temp=": "$r" },
                        { "->": ".^.^.0.s" },
                      ...
                      "c-1": [
                        ...
                        {
                          "^->":
                            "claim_hooper_took_component.0.we_wont_guess.c-7.6.c-1.$r2",
                        },
                        "/ev",
                        { "temp=": "$r" },
                        { "->": ".^.^.1.s" },
                        ...
                        [
                          [
                            ...
                            {
                              "^->":
                                "claim_hooper_took_component.0.we_wont_guess.c-7.6.c-1.12.0.$r1",
                            },
                            { "temp=": "$r" },
                            "str",
                            { "->": ".^.s" },
                          ...
                          [
                            ...
                            {
                              "^->":
                                "claim_hooper_took_component.0.we_wont_guess.c-7.6.c-1.12.1.$r1",
                            },
                            { "temp=": "$r" },
                            "str",
                            { "->": ".^.s" },
                          ...
                          [
                            ...
                            {
                              "^->":
                                "claim_hooper_took_component.0.we_wont_guess.c-7.6.c-1.12.2.$r1",
                            },
                            { "temp=": "$r" },
                            "str",
                            { "->": ".^.s" },
                          ...
                          ],
                          {
                            "c-0": [
                              ...
                              {
                                "^->":
                                  "claim_hooper_took_component.0.we_wont_guess.c-7.6.c-1.12.c-0.$r2",
                              },
                              "/ev",
                              { "temp=": "$r" },
                              { "->": ".^.^.0.s" },
                              ...
                              [
                                [
                                  ...
                                  {
                                    "^->":
                                      "claim_hooper_took_component.0.we_wont_guess.c-7.6.c-1.12.c-0.10.0.$r1",
                                  },
                                  { "temp=": "$r" },
                                  "str",
                                  { "->": ".^.s" },
                                ...
                                [
                                  ...
                                  {
                                    "^->":
                                      "claim_hooper_took_component.0.we_wont_guess.c-7.6.c-1.12.c-0.10.1.$r1",
                                  },
                                  { "temp=": "$r" },
                                  "str",
                                  { "->": ".^.s" },
                                ...
                                ],
                                {
                                  "c-0": [
                                    ...
                                    {
                                      "^->":
                                        "claim_hooper_took_component.0.we_wont_guess.c-7.6.c-1.12.c-0.10.c-0.$r2",
                                    },
                                    "/ev",
                                    { "temp=": "$r" },
                                    { "->": ".^.^.0.s" },
                                    [{ "#n": "$r2" }],
                                    '^ Probably under my bunk."',
                                    "\n",
                                  ...
                                  "c-1": [
                                    ...
                                    {
                                      "^->":
                                        "claim_hooper_took_component.0.we_wont_guess.c-7.6.c-1.12.c-0.10.c-1.$r2",
                                    },
                                    "/ev",
                                    { "temp=": "$r" },
                                    { "->": ".^.^.1.s" },
                                  ...
                                  "g-0": [
                                    ...
                                    [
                                      ...
                                      {
                                        "^->":
                                          "claim_hooper_took_component.0.we_wont_guess.c-7.6.c-1.12.c-0.10.g-0.3.$r1",
                                      },
                                      { "temp=": "$r" },
                                      "str",
                                      { "->": ".^.s" },
                                    ...
                                    [
                                      ...
                                      {
                                        "^->":
                                          "claim_hooper_took_component.0.we_wont_guess.c-7.6.c-1.12.c-0.10.g-0.4.$r1",
                                      },
                                      { "temp=": "$r" },
                                      "str",
                                      { "->": ".^.s" },
                                    ...
                                    ],
                                    {
                                      "c-2": [
                                        ...
                                        {
                                          "^->":
                                            "claim_hooper_took_component.0.we_wont_guess.c-7.6.c-1.12.c-0.10.g-0.c-2.$r2",
                                        },
                                        "/ev",
                                        { "temp=": "$r" },
                                        { "->": ".^.^.3.s" },
                                      ...
                                      "c-3": [
                                        ...
                                        {
                                          "^->":
                                            "claim_hooper_took_component.0.we_wont_guess.c-7.6.c-1.12.c-0.10.g-0.c-3.$r2",
                                        },
                                        "/ev",
                                        { "temp=": "$r" },
                                        { "->": ".^.^.4.s" },
                            ...
                            "c-1": [
                              ...
                              {
                                "^->":
                                  "claim_hooper_took_component.0.we_wont_guess.c-7.6.c-1.12.c-1.$r2",
                              },
                              "/ev",
                              { "temp=": "$r" },
                              { "->": ".^.^.1.s" },
                              [{ "#n": "$r2" }],
                              '^, then. As a colleague. Maybe I can get something useful out of him."',
                              "\n",
                              { "->": ".^.^.^.^.^.^.^.^.putmein" },
                              { "#f": 5 },
                            ],
                            "c-2": [
                              ...
                              {
                                "^->":
                                  "claim_hooper_took_component.0.we_wont_guess.c-7.6.c-1.12.c-2.$r2",
                              },
                              "/ev",
                              { "temp=": "$r" },
                              { "->": ".^.^.2.s" },
                ...
                "c-0": [
                  ...
                  [
                    [
                      ...
                      {
                        "^->":
                          "claim_hooper_took_component.harris_being_convinced.0.c-0.6.0.$r1",
                      },
                      { "temp=": "$r" },
                      "str",
                      { "->": ".^.s" },
                    ...
                    [
                      ...
                      {
                        "^->":
                          "claim_hooper_took_component.harris_being_convinced.0.c-0.6.1.$r1",
                      },
                      { "temp=": "$r" },
                      "str",
                      { "->": ".^.s" },
                    ...
                    ],
                    {
                      "c-0": [
                        ...
                        {
                          "^->":
                            "claim_hooper_took_component.harris_being_convinced.0.c-0.6.c-0.$r2",
                        },
                        "/ev",
                        { "temp=": "$r" },
                        { "->": ".^.^.0.s" },
                      ...
                      "c-1": [
                        ...
                        {
                          "^->":
                            "claim_hooper_took_component.harris_being_convinced.0.c-0.6.c-1.$r2",
                        },
                        "/ev",
                        { "temp=": "$r" },
                        { "->": ".^.^.1.s" },
      ...
      harris_takes_you_to_hooper: [
        [
          ...
          "\n",
          "ev",
          { "CNT?": "claim_hooper_took_component.0.g-1.hoopers_hut_3" },
          "/ev",
          [
            { "->": ".^.b", c: true },
            {
          ...
          { "*": ".^.c-2", flg: 20 },
          {
            ...
            "c-2": [
              ...
              [
                [
                  "ev",
                  { "^->": "harris_takes_you_to_hooper.0.c-2.6.0.$r1" },
                  { "temp=": "$r" },
                  "str",
                  { "->": ".^.s" },
                  [{ "#n": "$r1" }],
                ...
                ],
                {
                  "c-0": [
                    "ev",
                    { "^->": "harris_takes_you_to_hooper.0.c-2.6.c-0.$r2" },
                    "/ev",
                    { "temp=": "$r" },
                    { "->": ".^.^.0.s" },
                    [{ "#n": "$r2" }],
                  ...
                  only_catch: [
                    ...
                    [
                      ...
                      {
                        "^->":
                          "harris_takes_you_to_hooper.0.c-2.6.only_catch.2.$r1",
                      },
                      { "temp=": "$r" },
                      "str",
                      { "->": ".^.s" },
                    ...
                    [
                      ...
                      {
                        "^->":
                          "harris_takes_you_to_hooper.0.c-2.6.only_catch.3.$r1",
                      },
                      { "temp=": "$r" },
                      "str",
                      { "->": ".^.s" },
                    ...
                    ],
                    {
                      "c-1": [
                        ...
                        {
                          "^->":
                            "harris_takes_you_to_hooper.0.c-2.6.only_catch.c-1.$r2",
                        },
                        "/ev",
                        { "temp=": "$r" },
                        { "->": ".^.^.2.s" },
                      ...
                      "c-2": [
                        ...
                        {
                          "^->":
                            "harris_takes_you_to_hooper.0.c-2.6.only_catch.c-2.$r2",
                        },
                        "/ev",
                        { "temp=": "$r" },
                        { "->": ".^.^.3.s" },
            ...
            [
              ...
              { "*": ".^.c-2", flg: 20 },
              {
                ...
                "c-1": [
                  ...
                  2,
                  "/ev",
                  { "VAR=": "smashingWindowItem", re: true },
          ...
          [
            { "->": ".^.b" },
            {
              b: [
                ...
                [
                  { "->": ".^.b", c: true },
                  { b: ["^ my shoe by its toe, ", { "->": ".^.^.^.7" }, null] },
                ],
                [
                  { "->": ".^.b" },
                  { b: ["^back my arm, ", { "->": ".^.^.^.7" }, null] },
                ],
                "nop",
                { "->": ".^.^.^.8" },
                null,
      ...
      go_to_hoopers_dorm: [
              ...
              [
                ...
                { "*": ".^.c-1", flg: 20 },
                {
                  "c-0": [
                    ...
                    true,
                    "/ev",
                    { "VAR=": "putcomponentintent", re: true },
                    "ev",
                    false,
                    "/ev",
                    { "VAR=": "gotcomponent", re: true },
        ...
        ],
        {
          ...
          toss_component_into_bushes: [
            ...
            true,
            "/ev",
            { "VAR=": "throwncomponentaway", re: true },
            { "->": "return_to_room_after_excursion" },
            null,
          ],
          "#f": 1,
            ...
            [
              ...
              { "*": ".^.c-3", flg: 21 },
              {
                "c-0": [
                  "^ ",
                  "\n",
                  { "->": "night_falls.morning_not_saved.0.c-0" },
                  { "->": ".^.^.g-0" },
                  { "#f": 5 },
                ],
                "c-1": [
                  "^ ",
                  "\n",
                  { "->": "night_falls.morning_not_saved.0.c-1" },
                  { "->": ".^.^.g-0" },
                  { "#f": 5 },
                ],
                "c-2": [
                ...
                "g-0": [{ "->": ".^.^.^.^.found_missing_component" }, null],
              },
            ],
            null,
          ],
          found_missing_component: [
            [
              ...
              { "*": ".^.c-1", flg: 20 },
              {
                ...
                "g-1": [{ "->": "head_for_my_dorm_free" }, null],
              },
            ],
            null,
          ],
        ...
        [
          ...
          { "*": ".^.c-2", flg: 20 },
          {
            "c-0": [
              ...
              "\n",
              "ev",
              { "CNT?": "inside_hoopers_hut.back_of_hut_2" },
              "/ev",
              [
                { "->": ".^.b", c: true },
                {
          ...
          morning_not_saved: [
            [
              ...
              { "*": ".^.c-1", flg: 20 },
              {
                ...
                "g-0": [{ "->": "harris_certain_is_you" }, null],
              },
            ],
            null,
          ],
          ...
          { "*": ".^.c-3", flg: 20 },
          {
            ...
            "g-0": [
              ...
              [
                { "->": ".^.b" },
                {
                  b: ["^ its recovery does mean ", { "->": ".^.^.^.7" }, null],
                },
              ],
              "nop",
            ...
            "g-0": [
              ...
              { "*": ".^.c-5", flg: 21 },
              {
                ...
                "c-5": [
                  ...
                  true,
                  "/ev",
                  { "VAR=": "longgrasshooperframe", re: true },
                  "ev",
                  true,
                  "/ev",
                  { "VAR=": "piecereturned", re: true },
      ...
      reveal_location_of_component: [
        ...
        "ev",
        { "VAR?": "revealedhooperasculprit" },
        "/ev",
        [
          { "->": ".^.b", c: true },
          { b: ["^pass it to Hooper", { "->": ".^.^.^.7" }, null] },
        ],
        [
          { "->": ".^.b" },
          { b: ["^dispose of it", { "->": ".^.^.^.7" }, null] },
        ],
        "nop",
        ...
        { "->": ".^.harris_believes" },
        {
          harris_believes: [
            "ev",
            { "CNT?": "night_falls.0.g-0.c-3.6.hooper_didnt_give_himself_up" },
            "!",
            "/ev",
            [
              { "->": ".^.b", c: true },
      ...
      left_alone: [
        "ev",
        { "CNT?": "slam_door_shut_and_gone.time_to_move_now" },
        "/ev",
        [
          { "->": ".^.b", c: true },
          {
        ...
        [
          ...
          { "*": ".^.c-0", flg: 20 },
          {
            ...
            "g-0": [
              ...
              "\n",
              "ev",
              { "CNT?": "harris_threatens_lynching.0.c-0.4.too_clever" },
              "/ev",
              [
                { "->": ".^.b", c: true },
                {
            ...
            "g-1": [
              ...
              [
                ...
                [
                  "ev",
                  { "^->": "make_your_peace.0.g-1.monastic.4.$r1" },
                  { "temp=": "$r" },
                  "str",
                  { "->": ".^.s" },
                  [{ "#n": "$r1" }],
                ...
                ],
                {
                  "c-3": [
                    "ev",
                    { "^->": "make_your_peace.0.g-1.monastic.c-3.$r2" },
                    "/ev",
                    { "temp=": "$r" },
                    { "->": ".^.^.4.s" },
                    [{ "#n": "$r2" }],
            ...
            "g-2": [
              ...
              [
                { "->": ".^.b", c: true },
                {
                  b: ["^up my beautiful young man", { "->": ".^.^.^.8" }, null],
                },
              ],
              [
                { "->": ".^.b" },
